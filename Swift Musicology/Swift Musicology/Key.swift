...
public struct Key: Codable, Equatable, Hashable {
    ...
    public enum KeyType: Int, Codable, Equatable, Hashable, ExpressibleByStringLiteral, CustomStringConvertible {
        ...
        /// Use negative distance value for going towards left direction, and positive distance
        /// value for going on right direction. This function iterates the `KeyType.all`
        /// array circullar to find the target KeyType.
        ///
